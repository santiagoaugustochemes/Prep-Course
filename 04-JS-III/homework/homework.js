...
function incrementarPorUno(array) {
  ...
  for ( var i = 0 ; i < array.length ; i++) {
    var sumadeauno = array [i] + 1
  nuevoarray.push (sumadeauno) 
  }
  return nuevoarray
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
// array = [diciembre, enero, abril, junio, noviembre, julio, marzo]
...
function breakStatement(numero) {
  ...
  // Tu código:
  // numero = [52, 54, 56, 58, 60, 62, 64, 66, 68, 70]
